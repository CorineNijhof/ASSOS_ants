...
<experiments>
  ...
  <experiment name="clustering-center" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="colony 1" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>hours = 48</exitCondition>
    <metric>av-dist-cent-small</metric>
  ...
  <experiment name="colony 2" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>hours = 48</exitCondition>
    <metric>av-dist-cent-small</metric>
  ...
  <experiment name="colony 3" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>hours = 48</exitCondition>
    <metric>av-dist-cent-small</metric>
  ...
  <experiment name="colony 4" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>hours = 48</exitCondition>
    <metric>av-dist-cent-small</metric>
  ...
  <experiment name="colony 5" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>hours = 48</exitCondition>
    <metric>av-dist-cent-small</metric>
  ...
  <experiment name="equal-cd-center" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>hours = 48</exitCondition>
    <metric>av-dist-cent-small</metric>
  ...
  <experiment name="ln proportion moving" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>hours = 48</exitCondition>
    <metric>ln-prop-carried</metric>
    <enumeratedValueSet variable="nr_prepupae">
      <value value="20"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="nr_ants">
  ...
  <experiment name="clustering-bottom" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>hours = 48</exitCondition>
    <metric>av-ycor-small</metric>
  ...
  <experiment name="equal-cd-bottom" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>hours = 48</exitCondition>
    <metric>av-ycor-small</metric>
